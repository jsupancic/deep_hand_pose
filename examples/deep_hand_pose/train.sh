#!/usr/bin/env sh
# Draw the Net
# ./python/draw_net.py examples/deep_hand_pose/train_test.prototxt out/net.png && okular out/net.png
#
...
make -j16 &&
    popd &&
    gdb ./build/tools/caffe -ex 'catch throw' -ex "r train --solver=examples/deep_hand_pose/solver.prototxt $FINETUNE " -ex 'q' | tee out/log.txt
    #valgrind ./build/tools/caffe train --solver=examples/deep_hand_pose/solver.prototxt
